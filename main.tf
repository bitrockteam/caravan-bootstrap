module "vault_cluster" {
  source                         = "git::ssh://git@github.com/bitrockteam/caravan-vault//modules/cluster-raft?ref=refs/tags/v0.3.4"
...
module "vault_cluster_agents" {
  source              = "git::ssh://git@github.com/bitrockteam/caravan-vault//modules/agent?ref=refs/tags/v0.3.4"
...
module "consul-cluster" {
  source                         = "git::ssh://git@github.com/bitrockteam/caravan-consul//modules/consul-cluster?ref=refs/tags/v0.1.0"
  ssh_private_key                = var.ssh_private_key
...
module "nomad-cluster" {
  ...
  source                   = "git::ssh://git@github.com/bitrockteam/caravan-nomad//modules/nomad-cluster?ref=refs/tags/v0.1.10"
  ssh_private_key          = var.ssh_private_key
  cluster_nodes_ids        = var.control_plane_nodes_ids
  cluster_nodes            = var.control_plane_nodes
  cluster_nodes_public_ips = var.control_plane_nodes_public_ips
